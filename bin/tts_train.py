...
def get_parser():
   ...
   ###### dur_mask file #############
    ...
    parser.add_argument("--load-mask", type=strtobool, required=False, default=False)
    parser.add_argument('--train-mask-dir',type=str,default=None)
    parser.add_argument('--dev-mask-dir',type=str,default=None)
    parser.add_argument('--feat-pad-value',type=float,default=0)
