...
class Rhythm_Encoder(torch.nn.Module):
    """Encoder module of Spectrogram prediction network.
    ...
    def __init__(
        ...
        # define network layer modules
        self.embed = torch.nn.Embedding(idim, embed_dim, padding_idx=padding_idx)
        self.rhythm_embed=torch.nn.Embedding(rhythm_idim,embed_rhythm_dim,padding_idx=padding_idx)
        self.concat=torch.nn.Linear(embed_dim+embed_rhythm_dim,concat_dim)
